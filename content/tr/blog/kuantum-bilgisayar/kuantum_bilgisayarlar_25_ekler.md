...
5. **Microsoft Learn — The Qubit in Quantum Computing**  
   ...
   URL: https://learn.microsoft.com/en-us/azure/quantum/concepts-the-qubit

6. **Microsoft Learn — Dirac Notation**  
   Bra-ket notasyonu ve kuantum durumlarının matematiksel gösterimi için kısa açıklama.  
   URL: https://learn.microsoft.com/en-us/azure/quantum/concepts-dirac-notation
...
9. **IBM Quantum Learning — Bits, gates, and circuits**  
   ...
   URL: https://quantum.cloud.ibm.com/learning/courses/utility-scale-quantum-computing/bits-gates-and-circuits

10. **IBM Quantum Learning — Grover’s Algorithm**  
    Grover algoritması ve amplitude amplification için eğitim içeriği.  
    URL: https://quantum.cloud.ibm.com/learning/en/courses/utility-scale-quantum-computing/grovers-algorithm

11. **IBM Quantum Learning — Quantum Fourier Transform**  
    QFT ve phase estimation için temel modül.  
    URL: https://quantum.cloud.ibm.com/learning/modules/computer-science/qft
...
26. **D-Wave — Quantum Annealing Approach**  
    ...
    URL: https://www.dwavequantum.com/learn/d-wave-s-approach/
...
32. **Nature Index — Quantum error correction in quantum computing systems**  
    ...
    URL: https://www.nature.com/nature-index/topics/l4/quantum-error-correction-in-quantum-computing-systems
...
33. **Microsoft Azure Quantum — Resource Estimation**  
    ...
    URL: https://learn.microsoft.com/en-us/azure/quantum/overview-resources-estimator
...
45. **TÜBİTAK BİLGEM**  
    ...
    URL: https://bilgem.tubitak.gov.tr/
