...
- TÜBİTAK — QuantERA 2025 Yılı Çağrısı Açıldı.
- TÜBİTAK — Eureka Network Uygulamalı Kuantum Teknolojileri 2025 Çağrısı.
...
- NATO Science for Peace and Security — Quantum Technologies.
- IBM Quantum Learning — Quantum computing for business and industry perspectives.
- Microsoft Azure Quantum — Quantum computing and hybrid quantum workflows.
